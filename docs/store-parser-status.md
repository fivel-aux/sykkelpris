...
- **QA status: In QA — not approved.** Remaining open issues:
  - Image quality: manual UI review after the latest ingestion showed several listings with blurry/low-resolution images — requires a dedicated image-quality audit before full approval
